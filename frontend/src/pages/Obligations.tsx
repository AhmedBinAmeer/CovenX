...
import { AlertTriangle, CheckCircle2, ClipboardCheck, Clock3, ListFilter, RefreshCw, Sparkles } from 'lucide-react';
        ...
        <TiltCard className="card table-card obligation-table" maxTilt={1.2}>
          <div className="table-toolbar">
            ...
            <div className="segmented-control" aria-label="Obligation status view">
              <ListFilter size={14} style={{ margin: '7px 2px 0 7px', color: '#7890a0' }} />
              {views.map((item) => (
                <button
                  key={item.key}
          ...
          <div className="table-scroll">
            {items.length === 0 ? (
              <div className="empty">
                ...
                <span>Change the view or wait for the next lifecycle update.</span>
              </div>
            ) : (
              <table>
                <thead>
                    ...
                    <tr key={obligation._id}>
                      <td>
                        ...
                        <div style={{ color: '#8293a0', fontSize: 11, marginTop: 4 }}>
                          {obligation.type} · Contract {obligation.contractId}
                        </div>
                      </td>
                      <td>{obligation.ownerId}</td>
                      <td>
