...
const permissionKeys = [
  ...
  ['contract:history', 'contract', 'history', 'scope'], ['signature:request', 'signature', 'request', 'scope'], ['signature:read', 'signature', 'read', 'scope'], ['signature:complete', 'signature', 'complete', 'participant'], ['signature:decline', 'signature', 'decline', 'participant'], ['obligation:read', 'obligation', 'read', 'scope'], ['obligation:create', 'obligation', 'create', 'scope'], ['obligation:update', 'obligation', 'update', 'owner'], ['obligation:complete', 'obligation', 'complete', 'owner'], ['renewal:create', 'renewal', 'create', 'scope'], ['approval:read', 'approval', 'read', 'scope'], ['approval:approve', 'approval', 'approve', 'task'], ['approval:reject', 'approval', 'reject', 'task'], ['approval:delegate', 'approval', 'delegate', 'task'],
  ['document:read', 'document', 'read', 'scope'], ['document:upload', 'document', 'upload', 'scope'], ['document:download', 'document', 'download', 'scope'], ['document:delete', 'document', 'delete', 'scope'], ['document:manage', 'document', 'manage', 'tenant'], ['audit:read', 'audit', 'read', 'tenant'], ['report:read', 'report', 'read', 'scope']
];
...
export async function seedRbac(tenantId: string) {
  ...
  const roleSets: Record<string, string[]> = {
    ...
    'legal-officer': ['contract:read', 'contract:create', 'contract:update', 'contract:submit-review', 'contract:history', 'approval:read', 'approval:approve', 'approval:reject', 'signature:request', 'signature:read', 'signature:complete', 'signature:decline', 'document:read', 'document:upload', 'document:download', 'audit:read'],
    'department-manager': ['contract:read', 'contract:create', 'contract:update', 'contract:submit-review', 'contract:history', 'approval:read', 'approval:approve', 'obligation:read', 'obligation:create', 'obligation:update', 'obligation:complete', 'renewal:create', 'document:read', 'document:upload', 'document:download', 'report:read'],
