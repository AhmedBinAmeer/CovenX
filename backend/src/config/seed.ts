...
export async function seedRbac(tenantId: string) {
  ...
  const roleSets: Record<string, string[]> = {
    ...
    'legal-officer': ['contract:read', 'contract:create', 'contract:update', 'contract:submit-review', 'contract:history', 'contract:collaborate', 'contract:comment', 'contract:resolve-comment', 'approval:read', 'approval:approve', 'approval:reject', 'signature:request', 'signature:read', 'signature:complete', 'signature:decline', 'document:read', 'document:upload', 'document:download', 'audit:read'],
    'department-manager': ['contract:read', 'contract:create', 'contract:update', 'contract:submit-review', 'contract:history', 'contract:collaborate', 'contract:comment', 'approval:read', 'approval:approve', 'obligation:read', 'obligation:create', 'obligation:update', 'obligation:complete', 'renewal:create', 'document:read', 'document:upload', 'document:download', 'report:read'],
    ...
    'vendor-user': ['contract:read', 'contract:history', 'contract:collaborate', 'contract:comment', 'approval:read', 'approval:approve', 'document:read', 'document:upload', 'document:download']
  };
