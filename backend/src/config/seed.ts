...
const permissionKeys = [
  ...
  ['document:read', 'document', 'read', 'scope'], ['document:index', 'document', 'index', 'scope'], ['document:upload', 'document', 'upload', 'scope'], ['document:download', 'document', 'download', 'scope'], ['document:delete', 'document', 'delete', 'scope'], ['document:manage', 'document', 'manage', 'tenant'], ['audit:read', 'audit', 'read', 'tenant'], ['report:read', 'report', 'read', 'scope']
];
...
export async function seedRbac(tenantId: string) {
  ...
  const roleSets: Record<string, string[]> = {
    ...
    'legal-officer': ['contract:read', 'contract:create', 'contract:update', 'contract:submit-review', 'contract:history', 'contract:collaborate', 'contract:comment', 'contract:resolve-comment', 'approval:read', 'approval:approve', 'approval:reject', 'signature:request', 'signature:read', 'signature:complete', 'signature:decline', 'document:read', 'document:index', 'document:upload', 'document:download', 'audit:read'],
